...
\title{ML based Wireless Sensing Systems for Robotics and IoT Applications}
\author{Sai Roshan Ayyalasomayajula}
\degree{Signal and Image Processing}{Doctor of Philosophy}
% Each member of the committee should be listed as Professor Foo Bar.
% If Professor is not the correct title for one, then titles should be
% omitted entirely.
\chair{Professor Dinesh Bharadia}
% \cochair{Professor Gamma Delta} % Optional
% Your committee members (other than the chairs) must be in alphabetical order
\committee{Professor Alex C Snoren}
\committee{Professor Xinyu Zhang}
\committee{Professor Nuno Vasconcelos}
\committee{Professor Deepak Vasisht}
\degreeyear{2023}
